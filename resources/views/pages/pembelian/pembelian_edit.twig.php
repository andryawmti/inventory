...
{% set barangs = params.barangs %}
{% set pembelian = params.pembelian[0] %}
{% set id_transaksi = pembelian.id_transaksi %}
{% set detail_pembelian = params.detail_pembelian %}
{% block main_content %}
<script>
    var prod = {{ detail_pembelian | json_encode |raw }};
    let tot = {{pembelian.total_harga}}
</script>
<!-- START Page content-->
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" id="updatePembelian" action="{{ url('/pembelian') }}/{{pembelian.id_transaksi}}" data-parsley-validate = "" novalidate="" class="form-horizontal">
                <!-- START panel-->
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="tgl_transaksi" readonly="readonly" value="{{ pembelian.tgl_transaksi | date('Y-m-d') }}" required="required" class="form-control date_picker">
                            </div>
                            ...
                            <div class="col-sm-3">
                                <select id="id_distributor" required="required" class="form-control">
                                    ...
                                    <option {% if pembelian.id_distributor == distributor.id_ditributor %}selected="selected"{%endif%} value="{{ distributor.id_distributor }}">
                        ...
                        <div class="table-responsive table-stripped table-bordered">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><strong id="total">{{pembelian.total_harga}}</strong></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<script type="text/javascript">
    ...
    $('#updatePembelian').on('submit', function(e){
        if(produks.length <= 0) {
        ...
        let my_url = $('#updatePembelian').attr('action');
        console.log(my_url);
        let ajax_params = {
            headers: {
            ...
            dataType: 'JSON',
            data: {
                'produks':produks, 'id_distributor':id_distributor, 'tgl_transaksi':tgl_transaksi, 'total':total, '_method':'PUT'
            },
            success: function(result,status,xhr){
    ...
    //dont use it
    function simpanPembelian(barangs){
        e.preventDefault();
        $.ajax({
            type: 'POST',
            url: '/produk/store',
