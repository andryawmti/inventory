...
{% block main_content %}
         ...
         <div class="content-wrapper">
            <h3>Laporan Pembelian
               <small>Anda bisa dapat mencetak laporan pembelian dari halaman ini.</small>
            </h3>
            <ol class="breadcrumb">
               <li>
                  <a href="/">Dashboard</a>
               ...
               <li class="active"><a href="{{route('report.pembelian')}}">Laporan Pembelian</a></li>
            </ol>
            <!-- START row-->
            <div class="row">
               <div class="col-md-12">
                  <form method="POST" action="{{ route('export.pembelian') }}" class="form-horizontal" novalidate="" data-parsley-validate="">
                     <!-- START panel-->
...
<!--                            </fieldset>-->
                        ...
                        <div class="panel-footer text-center">
                           <a href="{{ url('pembelian') }}" class="btn btn-primary"><span class="fa fa-file-text"></span>&nbsp;Data Pembelian</a>
                        </div>
                     </div>
                     <!-- END panel-->
                  </form>
